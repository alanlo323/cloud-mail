const en = {
    ...
    notSpam: 'Not spam',
    markAsSpamConfirm: 'Mark {count} selected email(s) as spam?',
    blockSenderAlso: 'Also block this sender (future mail goes to spam)',
    spamBlockHint: 'Uncheck to move only this email without creating a personal block rule',
    markSpamSuccess: 'Marked as spam',
    restoreSpamConfirm: 'Move selected email(s) back to inbox?',
    restoreSpamRuleHint: 'If this sender was blocked, restoring will remove the block rule. Other spam from the same sender stays in Spam.',
    restoreSpamSuccess: 'Moved to inbox',
    settings: 'Settings',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
