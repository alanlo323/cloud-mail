const zh = {
    ...
    markAsSpam: '标记为垃圾邮件',
    notSpam: '不是垃圾邮件',
    markAsSpamConfirm: '确定将选中的 {count} 封邮件标记为垃圾邮件？',
    blockSenderAlso: '同时屏蔽此发件人（未来邮件自动进垃圾箱）',
    spamBlockHint: '取消勾选则只移动本封，不建立个人屏蔽规则',
    markSpamSuccess: '已标记为垃圾邮件',
    restoreSpamConfirm: '确定将选中的邮件移回收件箱？',
    restoreSpamRuleHint: '若曾屏蔽该发件人，恢复时会解除屏蔽规则；同发件人其余垃圾邮件仍留在垃圾箱。',
    restoreSpamSuccess: '已移回收件箱',
    settings: '个人设置',
    analytics: '分析页',
    allUsers: '用户列表',
    allMail: '全部邮件',
